...
void AMyPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("Global", IE_Pressed, this, &AMyPlayerController::OnGlobalPressed);
}
...
void AMyPlayerController::OnGlobalPressed()
{
	//get pawn
	APawn* MyPawn = GetPawn();
	...
	FVector newLocation = FVector(vehiclePos.X, vehiclePos.Y, 4000);
